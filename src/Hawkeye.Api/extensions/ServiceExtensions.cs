...
{
    /// <summary>
    ///     Extension method allowing to use generic forms of <c>GetService</c> on
    ///     <see cref="IServiceProvider" /> instances, and generic forms of
    ///     <c>AddService</c> and <c>RemoveService</c> on
    ///     <see cref="IServiceContainer" /> instances.
    /// </summary>
    public static class ServiceExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="T">Type of service to be recovered.</typeparam>
        ...
        ///     <para>
        ///         Si à <c>true</c> , lève une exception
        ///         <see cref="Hawkeye.ComponentModel.ServiceNotFoundException`1" />
        ///     </para>
        ///     <para>
        ///         dans le cas où le service demandé n'a pas pu être trouvé.
        ///     </para>
        /// </param>
        /// <returns>
        ///     L'instance de service ou
        ///     <b>
        ///         <see langword="null" />
        ///     </b>
        /// </returns>
        ...
        /// <param name="callback">
        ///     Objet de rappel utilisé pour créer le service. Cela permet à un
        ///     service d'être déclaré comme disponible, mais retarde la création de
        ///     l'objet jusqu'à ce que le service soit demandé.
        /// </param>
        ...
        /// <summary>
        ///     Ajoute le service spécifié au conteneur de services et promeut
        ///     éventuellement le service vers les conteneurs de services parents
        ///     éventuels.
        /// </summary>
        /// <typeparam name="T">Type de service à ajouter.</typeparam>
        /// <param name="serviceContainer">The service container.</param>
        ...
        ///         <see langword="true" />
        ///     </b>
        ///     pour promouvoir cette demande vers les conteneurs de services
        ///     parents éventuels ; sinon,
        ///     <b>
        ///         <see langword="false" />
        ///     </b>
        ///     .
        ...
        ///     Instance du type de service à ajouter. Cet objet doit implémenter le
        ///     type indiqué par <typeparamref name="T" /> ou en hériter.
        /// </param>
        ...
        ///     .
        /// </param>
        public static void AddService<T>(this IServiceContainer serviceContainer, T serviceInstance, bool promote)
            where T : class
        {
        ...
        /// <summary>
        ///     Supprime le type de service spécifié du conteneur de service et
        ///     promeut éventuellement la demande vers les conteneurs de service
        ///     parents.
        /// </summary>
        ...
        /// <summary>
        ///     Supprime le type de service spécifié du conteneur de services.
        /// </summary>
        /// <typeparam name="T">Type de service à supprimer.</typeparam>
        /// <param name="serviceContainer">The service container.</param>
