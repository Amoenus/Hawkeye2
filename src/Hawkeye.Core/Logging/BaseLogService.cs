...
{
    /// <summary>
    ///     Abstract base class allowing for a quick implementation of a logging
    ///     service.
    /// </summary>
    /// <seealso cref="T:Hawkeye.Logging.ILogService" />
    internal abstract class BaseLogService : ILogService
    {
        ...
        /// <summary>
        ///     Makes a <see cref="ILogEntry" /> object from the specified
        ///     parameters.
        /// </summary>
