...
namespace Hawkeye.Logging.log4net
{
    ...
    {
        /// <summary>
        ///     Converts a Sopra flavor trace <paramref name="level" /> (
        ///     <see cref="LogLevel" /> ) into a log4net like
        ///     <paramref name="level" /> ( <see cref="Level" /> ).
        /// </summary>
        /// <param name="level">The trace level to convert.</param>
        /// <returns>
        ///     log4net converted trace level.
        /// </returns>
        ...
        /// <summary>
        ///     Converts a log4net flavor trace <paramref name="level" /> (
        ///     <see cref="Level" /> ) into a Sopra like <paramref name="level" /> (
        ///     <see cref="LogLevel" /> ).
        /// </summary>
        /// <param name="level">The log4net level to convert.</param>
        /// <returns>
        ///     Sopra converted trace level.
        /// </returns>
        ...
        /// <summary>
        ///     Loggings a log4net flavor logging event (
        ///     <see cref="LoggingEvent" /> ) into a Sopra Log entry (
        ///     <see cref="LogEntry" /> ).
        /// </summary>
        ...
        public static LogEntry LoggingEventToLogEntry(LoggingEvent loggingEvent)
        {
            ...
            string message = loggingEvent.MessageObject?.ToString() ?? loggingEvent.RenderedMessage;
